...
export const Information = ({ images }: InformationProps) => {
  ...
  return (
    ...
    >
      <motion.div className="info__container"
      ...
      >
        ...
        <div className="info__content">
            <motion.div className="info__paragraph"
              ref={MarttiRef}
            ...
            >
              <p>
                ...
                Suscipit aut pariatur dolor at voluptas! 
                Quo culpa, vitae officiis non enim pariatur beatae adipisci temporibus ipsam atque recusandae quos. Cumque, fuga.
              </p>
            </motion.div>
            <motion.div className="info__image"
                ref={MarttiRef}
                viewport={{ margin: "-100px" }}
      ...
      >
        ...
        <div className="info__content">
            <motion.div className="info__paragraph"
              ...
              transition={{ duration: 2 }}
            >
                <p className="info__instructions">If you have any questions or we peeked your interest, please shoot us an email!</p>
                <p>
                E-mail: arkkijalkapallo@gmail.com
                </p>
            </motion.div>
        </div>
      </motion.div>
